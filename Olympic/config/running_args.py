...
def get_args(rest_args):
    ...
    parser.add_argument('--solved_reward', type=int, default=700000, help='desired reward')
    ...
    parser.add_argument('--load_model_time', type=str, default="12_6_16_49", help='month_day_hour_minute')
