...
def get_args(rest_args):
    ...
    parser.add_argument('--solved_reward', type=int, default=-1000000, help='desired reward')
    ...
    parser.add_argument('--load_model_time', type=str, default="11_28_21_37", help='month_day_hour_minute')
